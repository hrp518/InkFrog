/**
 * @file lv_conf.h
 * Configuration file for EPD_3IN52 (240x415 monochrome)
 */
...
#define LV_COLOR_DEPTH           1       /* 单色模式: 1字节/像素 */
...
#define LV_DISP_DEF_REFR_PERIOD  300     /* 墨水屏需要300ms刷新间隔 */

/*Input device read period in milliseconds*/
#define LV_INDEV_DEF_READ_PERIOD 50      /* 触摸轮询50ms */
...
/*Layer buffer sizes for opacity effects*/
...
#define LV_ASSERT_HANDLER do { printf("\r\n[LVGL ERR] ASSERT FAILED! File: %s, Line: %d\r\n", __FILE__, __LINE__); while(1); } while(0);
...
#define LV_FONT_MONTSERRAT_12   1       /* 只保留12px字体 */
...
#define LV_USE_KEYBOARD         1       /* 启用键盘用于重命名功能 */
#define LV_USE_LED             0
 ...
 * Themes
 *----------*/
#define LV_USE_THEME_DEFAULT     0       /* 关闭默认主题 */
#define LV_USE_THEME_BASIC      0       /* 关闭基础主题 */
#define LV_USE_THEME_MONO       1       /* 启用单色主题 */

/*-----------
 * Layouts
 *-----------*/
#define LV_USE_FLEX             1       /* 启用Flex布局(lv_list需要) */
#define LV_USE_GRID            0       /* 关闭Grid布局节省资源 */
...
#define LV_USE_FS_FATFS        1       /* 启用FATFS支持，用于从SD卡加载字体 */
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER    '0'        /* SD卡盘符 */
    #define LV_FS_FATFS_CACHE_SIZE  (4 * 1024)  /* 缓存大小4KB */
#endif
...
#define LV_USE_TINY_TTF        1       /* 启用Tiny-TTF，支持从SD卡加载TTF字体 */
